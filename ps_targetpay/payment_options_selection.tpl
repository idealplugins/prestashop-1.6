...
<!-- REMOVE AFTER THIS LINE IF YOU ONLY WANT IDEAL -->
...
<div class="row">
	<div class="col-xs-12 col-md-6">
        <p class="payment_module">
            <a href="index.php?fc=module&module=ps_targetpay&controller=payment&bankID=MRC" class="mistercash" title="Mister Cash">
                {l s='Betaal via Mister Cash' mod='ps_targetpay'} 
            </a>
        </p>
    </div>
</div>
	...
	<div class="col-xs-12 col-md-6">
        <p class="payment_module">
            <a href="#" id="sofort-toggle" class="sofort" title="Sofort Banking">
                {l s='Betaal via Sofort' mod='ps_targetpay'} 
            </a>
        </p>
    </div>
